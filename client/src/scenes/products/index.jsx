    ...
    <Box m="1.5rem 2.5rem">
      ...
      {data || !isLoading ? (
        <Box
          ...
          rowGap="20px"
          columnGap="1.33%"
          // sets a span of 4 for all child elements of this box (fills whole grid)
          // "& > div" selects all the following divs
          sx={{
            "& > div": { gridColumn: isNonMobile ? undefined : "span 4" },
          }}
        >
          {/* destructure from data and pass to product component */}
          {data.map(
            ({
              _id,
              name,
